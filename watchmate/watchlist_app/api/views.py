...
class ReviewCreate(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        # Use get_user_model() to get the user model dynamically
        review_user = self.request.user if self.request.user.is_authenticated else None
...
#         serialiezer = MovieSerializer(movies, many=True)
...
#         #we need to select the exact object that we are going to uptade
#         movie = Movie.objects.get(pk=pk)
